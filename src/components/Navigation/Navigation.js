          ...
          <Nav.Item>
            <NavBar.Brand>
              <img
                ...
                className="d-inline-block nav-logo-style"
                alt="Book Hero logo"
              />
            </NavBar.Brand>
            <NavBar.Brand>Book Hero</NavBar.Brand>
          </Nav.Item>
        </Nav>
      </NavBar>
    );
  } else if (!readerMode) {
    // logged in, not in the reader
      ...
      <NavBar className="justify-content-center">
        <Nav className="mr-auto">
          ...
          <NavDropdown title="Account" id="basic-nav-dropdown">
            ...
            <NavDropdown.Item>
              <LinkContainer to="/refill" exact={true}>
